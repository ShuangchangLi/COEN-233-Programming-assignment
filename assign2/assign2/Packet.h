...
void printStatus(unsigned short status)
{
    ...
    {
    case ACCESS_OK:
        printf("Server responded with subscriber status: 0xFFFB\n");
        printf("Subscriber Access Granted\n");
        break;
    case NOT_PAID:
        printf("Server responded with subscriber status: 0xFFF9\n");
        printf("Subscriber Not Paid\n");
        break;
    case NOT_EXIST:
        printf("Server responded with subscriber status: 0xFFFA\n");
